...
export declare type FetchRequestOptions = AxiosRequestConfig;
...
export declare type SolrClientParams = {
    /**
...
export declare type FullSolrClientParams = {
    host: string;
    port: string | number;
    core: string;
    path: string;
...
export declare type Pivot = {
    mincount?: number;
    fields: any;
};
export declare type MltOptions = {
    on?: boolean;
    fl?: string | string[];
    count?: number;
    mintf?: number;
