...
class Query {
    constructor(options) {
        this.qt = Query.prototype.requestHandler;
        this.restrict = Query.prototype.fl;
    ...
    matchFilter(field, value) {
        ...
        if (Array.isArray(value)) {
            value = value.map(format_1.dateISOify);
            value = `(${value.join(' OR ')})`;
        }
        else {
    ...
    mlt(options) {
        ...
        if (options.fl) {
            if (options.fl instanceof Array)
    ...
    hl(options) {
        ...
        if (options.maxMultiValuedToExamine !== undefined) {
            this.parameters.push('hl.maxMultiValuedToExamine=' +
                encodeURIComponent(options.maxMultiValuedToExamine));
        }
        if (options.maxMultiValuedToMatch !== undefined) {
            this.parameters.push('hl.maxMultiValuedToMatch=' +
        ...
        if (options.maxAlternateFieldLength !== undefined) {
            this.parameters.push('hl.maxAlternateFieldLength=' +
        ...
        if (options.highlightMultiTerm !== undefined) {
            this.parameters.push('hl.highlightMultiTerm=' +
                encodeURIComponent(options.highlightMultiTerm));
        }
        if (options.usePhraseHighlighter !== undefined) {
            this.parameters.push('hl.usePhraseHighlighter=' +
        ...
        if (options.regexMaxAnalyzedChars) {
            this.parameters.push('hl.regex.maxAnalyzedChars=' +
