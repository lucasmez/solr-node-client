import { Filters, HlOptions, MltOptions, TermsOptions, GroupOptions, FacetOptions, DateOptions, JoinOptions } from './types';
...
export declare class Query {
     ...
     */
    matchFilter(field: string, value: string | string[] | number | number[] | Date | Date[] | boolean): Query;
    /**
